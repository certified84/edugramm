...
const AddPostScreen: React.FC<Props> = ({ route, navigation }) => {
  ...
  async function updatePost(url: string, id: string) {
    ...
    setValues({ ...values, loading: true });
    await updateDoc(postRef, { images: [url] })
      .then(() => {
        setValues({ ...values, loading: false });
        navigation.goBack();
      })
      ...
      <View style={{ flex: 1, paddingHorizontal: SIZES.md }}>
        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
          <TouchableOpacity
            ...
            style={{ paddingVertical: SIZES.xxs }}
          >
          ...
          <TouchableOpacity
            ...
            style={{
              opacity:
                values.post.length > 0 || values.images.length > 0 ? 1 : 0.5,
            }}
        ...
        <View style={{ flexDirection: "row", flex: 0.8, marginTop: SIZES.sm }}>
          ...
          <View style={{ flex: 1 }}>
            <View style={{ flexDirection: "row", alignItems: "center" }}>
              <Text style={{ ...TYPOGRAPHY.h3, marginStart: SIZES.sm }}>
                {user.displayName}
              </Text>
        ...
        <View style={{ flex: 0.2, alignItems: "center" }}>
          <TouchableOpacity onPress={pickImages} style={styles.btnPickImage}>
