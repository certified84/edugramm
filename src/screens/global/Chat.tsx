...
import { SafeAreaView, TouchableOpacity, View, Text, StyleSheet, Platform, StatusBar, Image, KeyboardAvoidingView } from "react-native";
...
import { GiftedChat, Bubble, Actions, Send, InputToolbar } from 'react-native-gifted-chat'
...
export default function ChatScreen({ route }) {
    ...
    const onSend = useCallback((messages = []) => {
        setValues(previousState => ({ ...values, messages: GiftedChat.append(previousState.messages, messages) }))
    ...
    const renderSend = (props) => {
        return (
            <Send {...props}>
                <View style={{ padding: SIZES.xxs + 4, borderRadius: 100, alignItems: 'center', marginHorizontal: SIZES.xxs, backgroundColor: COLORS.onSecondary }}>
    ...
    const renderInputToolbar = (props) => {
       ...
       return <InputToolbar {...props} containerStyle={{borderTopWidth: 1.5, borderTopColor: '#333', backgroundColor: COLORS.surface}} />
     }
