  ...
  useEffect(() => {
    navigation.setOptions({
      headerRight: () => {
        return (
          <TouchableOpacity
            onPress={() => (values.image ? uploadImage() : updateUserProfile())}
          >
      ...
      <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false}>
        <View style={{ flex: 1 }}>
          ...
          >
            ...
            >
              {values.image || user.photoURL ? (
                <View>
                  {values.image ? (
                    <Avatar.Image size={80} source={{ uri: values.image }} />
                  ) : (
          ...
          <View style={{}}>
            ...
            >
              <Text style={{ ...TYPOGRAPHY.h3, flex: 0.25 }}>Name</Text>
              <View style={{ flex: 1 }}>
                <TextInput
            ...
            >
              <Text style={{ ...TYPOGRAPHY.h3, flex: 0.25 }}>Link</Text>
              <View style={{ flex: 1 }}>
                <TextInput
                  value={values.link}
                  onChangeText={(text) => {
            ...
            <TouchableOpacity
              activeOpacity={0.5}
              style={{ paddingVertical: SIZES.sm, marginStart: SIZES.md }}
            >
              <Text style={{ ...TYPOGRAPHY.h3, color: COLORS.primary }}>
                Sign up for Edugramm Verfied
              </Text>
            </TouchableOpacity>
          </View>
        </View>
