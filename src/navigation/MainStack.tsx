...
import {
    ...
    NotificationScreen, ProfileScreen, UserDetailScreen, FollowScreen, AddPostScreen,
    EditProfileScreen, SettingsScreen, CreateCommunityScreen, CommunityDetailScreen,
} from '../screens';
